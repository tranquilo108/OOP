...
/**
 * Интерфейс с методами: printAllStudents(List<Student> students), prompt(),
 * help(), exit(), emptyList(), delete(), resultOfDelete(boolean f), greeting()
 * которые реализованы в классах типа View
 */
public interface iGetView {
    /**
     * Метод выводит список студентов на консоль, принимая список студентов List<> в
     * качестве параметра
     * List<>
     */
