 ...
 */
    ...
    /**
 * Сравнивает текущего студента с переданным, используя возраст и уникальный идентификатор.
 *
 * @param o Студент, с которым нужно сравнить текущего студента.
 * @return 0, если студенты равны, -1, если текущий студент меньше переданного, и 1, если текущий студент больше переданного.
 */
    @Override
